...
/*define if getaddrinfo prtotype is in <netdb.h> */
...
/*define uf getnameinfo prototype is in <netdb.h>*/
...
#define HAVE_IF_NAMETOINDEX_STRUCT	1
...
/*Define if you have the ANSI C header file.*/
...
/*define to __ss_family if sockaddr_storage has that instead
of ss_family*/
/*#undef ss_family*/
